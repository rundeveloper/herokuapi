...
class Datos extends Database
{
	...
	public function createUsuarioModel($datosModel, $tabla){
		$stmt = Database::getConnection()->prepare("INSERT INTO $tabla (fullname, username, password, secretpin, created) VALUES (:fullname, :username, :password, :secretpin, :created)");
